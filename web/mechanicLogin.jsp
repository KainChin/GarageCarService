...
<html lang="en">
    ...
    <body>
        ...
        <div class="login-container">
            <img src="https://png.pngtree.com/png-clipart/20240508/original/pngtree-a-car-mechanic-cartoon-character-png-image_15035143.png" alt="?nh nhân viên" class="profile-img">
            <h2>Mechanic Login</h2>
            <form action="/GarageCarService/LoginMechaServlet" accept-charset="UTF-8" method="post">
