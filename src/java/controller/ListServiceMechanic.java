 ...
 * @author Dell
 */
@WebServlet(name = "ListServiceMechanic", urlPatterns = {"/ListServiceMechanic"})
public class ListServiceMechanic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Mechanic mechanic = (Mechanic) session.getAttribute("user");
            
            String mechanicID = request.getParameter("mechanicID");
            ServiceMechanicDAO dao = new ServiceMechanicDAO();
            List<ServiceMechanic> list = dao.getList(mechanicID);
